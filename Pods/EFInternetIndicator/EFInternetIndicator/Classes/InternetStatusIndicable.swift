...
extension InternetStatusIndicable where Self: UIViewController {
    ...
    public func startMonitoringInternet(backgroundColor: UIColor = UIColor.red, style: MessageView.Layout = .StatusLine, textColor: UIColor = UIColor.white, message: String = "Lutfen internet baglantinizi kontrol edin", remoteHostName: String = "apple.com") {
